  ...
  return (
    <div className="interview-page">
      <div className="interview-container">
        ...
        <aside className="sidebar-left">
          ...
          <nav className="nav-tabs">
            ...
            >
              ...
              <span className="tab-label">Technical Questions</span>
            ...
            >
              ...
              <span className="tab-label">Behavioral Questions</span>
            ...
            >
              ...
              <span className="tab-label">Preparation Plan</span>
        ...
        <main className="content-middle" ref={contentRef}>
          {activeTab === "technical" && (
            <>
              {/* Sticky header — direct child of scroll container, no parent padding */}
              <div className="section-header">
                <div className="header-inner">
                  ...
                  <div className="header-stat">
                    <span className="stat-val">{report.technicalQuestions.length}</span>
                    <span className="stat-label">Questions</span>
                  </div>
                </div>
              </div>

              {/* Scrollable content — carries its own padding */}
            ...
            <>
              <div className="section-header">
                <div className="header-inner">
                  ...
                  <div className="header-stat">
                    <span className="stat-val">{report.behavioralQuestions.length}</span>
                    <span className="stat-label">Questions</span>
                  </div>
                </div>
              </div>
            ...
            <>
              <div className="section-header">
                <div className="header-inner">
                  ...
                  <div className="header-stat">
                    <span className="stat-val">{report.preparationPlan.length}</span>
